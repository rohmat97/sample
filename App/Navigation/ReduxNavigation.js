...
import { subscribe as branchSubscriber, listenInstallAndFirstOpen } from '../Services/Branch'
...
class ReduxNavigation extends React.Component {
  ...
  componentDidMount() {
    ...
    listenInstallAndFirstOpen()
    this._unsubscribeBranch = branchSubscriber(dispatch)
  }
