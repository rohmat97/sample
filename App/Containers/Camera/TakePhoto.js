...
function TakePhoto(props) {
  ...
  const onCaptured = ({ heightImg, widthImg, imageUri, orientation }) => {
    navigate('TakePhotoPreviewScreen', { heightImg, widthImg, imageUri, orientation, source: getParam('source') })
  }
